...
var akshat: User = User(name: "Akshat", age: 20, height: 1.85, weight: 75, activityLevel: 7)
print("Hello, my name is \(akshat.name) and I am \(akshat.age) years old.")
print("I am \(akshat.height) meters tall and weigh \(akshat.weight) kilograms.")
print("I am \(akshat.activityLevel)) active.")
/*:
...
var parkDistance = Distance(feet: 3280.84)
print("Feet: \(parkDistance.feet)")
print("Meters: \(parkDistance.meters)")
/*:
