 ...
 */
var walkingChallenges: [String] = ["10000 steps per day", "Morning stroll"]
var runningChallenges: [String] = ["Weekly 10 K", "Sprints"]
...
committedChallenges = ["10000 steps per day"]
