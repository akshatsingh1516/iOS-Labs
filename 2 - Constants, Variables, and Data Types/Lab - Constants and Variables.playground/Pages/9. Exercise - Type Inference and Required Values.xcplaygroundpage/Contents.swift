...
var name: String;
//print(name);
print("No, the code does not compile because name is not of type String")
...
print("No, the code does not compile because distanceTraveled is not of type Double")
/*:
