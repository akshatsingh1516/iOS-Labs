...
heartRate = 74             // Updated after fixing the monitor
...
let oldHR3 = 79
let oldHR4 = 70
var hrAverage : Int? = 74

if let calculateAvg =   heartRate {
    let totalHR = oldHR1 + oldHR2 + oldHR3 + oldHR4 + calculateAvg
        let hrAverage: Int = totalHR / 5
    print("Average heart rate: \(hrAverage)")
}else{
    print("No valid heart rate to calculate average.")
}
